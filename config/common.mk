...
PRODUCT_COPY_FILES += \
    vendor/futute/prebuilt/common/bin/backuptool_ab.sh:system/bin/backuptool_ab.sh \
...
# Bootanimation
$(call inherit-product, vendor/future/config/bootanimation.mk)

# Hidden API whitelist
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/etc/permissions/aex-hiddenapi-package-whitelist.xml:system/etc/permissions/aex-hiddenapi-package-whitelist.xml

# priv-app permissions
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/etc/permissions/privapp-permissions-aex.xml:system/etc/permissions/privapp-permissions-aex.xml

DEVICE_PACKAGE_OVERLAYS += \
    vendor/future/overlay/common \
    vendor/future/overlay/dictionaries
...
PRODUCT_COPY_FILES += \
    ...
    vendor/future/prebuilt/common/etc/permissions/default-permissions/org.pixelexperience.weather.client.xml:system/etc/default-permissions/org.pixelexperience.weather.client.xml
...
# Markup libs
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/lib/libsketchology_native.so:system/lib/libsketchology_native.so \
    vendor/future/prebuilt/common/lib64/libsketchology_native.so:system/lib64/libsketchology_native.so

# Pixel sysconfig
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/etc/sysconfig/pixel.xml:system/etc/sysconfig/pixel.xml
...
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/etc/init.local.rc:root/init.aosp.rc

# Bring in camera effects
PRODUCT_COPY_FILES +=  \
    vendor/future/prebuilt/common/media/LMspeed_508.emd:system/media/LMspeed_508.emd \
