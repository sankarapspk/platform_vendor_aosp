...
EXTENDED_MOD_VERSION := FutureExtended-$(EXTENDED_VERSION)-$(EXTENDED_BUILD_DATE)-$(EXTENDED_BUILD_TYPE)
EXTENDED_FINGERPRINT := FutureExtended/$(EXTENDED_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(EXTENDED_BUILD_DATE)
...
EXTENDED_DISPLAY_VERSION := FutureExtended-$(EXTENDED_VERSION)-$(EXTENDED_BUILD_TYPE)
